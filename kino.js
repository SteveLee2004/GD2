    ...
    const archiveData = {
        ...
        "35mm": {
            ...
            movies: [
                ...
                { title: "A CLOCKWORK ORANGE", director: "Stanley Kubrick", type: "color", year: 1971, frames:[]},
                ...
                { title: "BATMAN", director: "Tim Burton", type: "Color", year: 1989, fames: []},
                { title: "GOODFELLAS", director: "Martin Scorsese", type: "Color", year: 1990, frames:[]},
                { title: "TERMINATOR 2: JUDGEMENT DAY", director: "James Cameron", type: "Color", year: 1991, frames:[]},
                { title: "WHITE MEN CAN'T JUMP", director: "Ron Shelton", type: "Color", year: 1992, frames:[]},
                { title: "TRUE ROMANCE", director: "Tony Scott", type: "Color", year: 1993, frames:[]},
                { title: "PULP FICTION", director: "Quentin Tarantino", type: "Color", year: 1994, frames:[]},
                { title: "THE HEAT", director: "Michael Mann", type: "Color", year: 1995, frames:[]},
                { title: "ROMEO + JULIET", director: "Baz Luhrmann", type: "Color", year: 1996, frames:[]},
                { title: "ALIEN: RESURRECTION", director: "Jean-Pierre Jeunet", type: "Color", year: 1997, frames:[]},
                { title: "FEAR AND LOATHING IN LAS VEGAS", director: "Terry Gilliam", type: "Color", year: 1998, frames:[]},
                { title: "FIGHT CLUB", director: "David Fincher", type: "Color", year: 1999, frames: ["fightclub-images/fightclub1.png", "fight2.jpg"] },
                { title: "BATTLE ROYALE", director: "Kinji Fukasaku", type: "Color", year: 2000, frames:[]},
                { title: "DONNIE DARKO", director: "Richard Kelly", type: "Color", year: 2001, frames:[]},
                { title: "CATCH ME IF YOU CAN", director: "Steven Spielberg", type: "Color", year: 2002, frames:[]},
                { title: "OLD BOY", director: "Park Chan-Wook", tyoe: "Color", year: 2003, frames: []},
                { title: "SPIDER MAN 2", director: "Sam Raimi", type: "Color", year: 2004, frames:[]},
                { title: "THERE WILL BE BLOOD", director: "Paul Thomas Adnerson", type: "Color", year: 2007, frames: ["blood-images/blood1.png", "country2.jpg"] },
                { title: "SNOWPIERCER", director: "Bong Joon-Ho", type: "Color", year: 2013, frames:[]},
                { title: "UNCUT GEMS", director: "Josh and Benny Safdie", type: "Color", year: 2019, frames: ["uncut-images/uncut1.png", "uncut2.jpg"] },
                { title: "LAST NIGHT IN SOHO", director: "Edgar Wright", type: "Color", year: 2021, frames: []},
