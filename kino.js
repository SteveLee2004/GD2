$(document).ready(function() {
    ...
    const archiveData = {
        "16mm": {
            summary: "Introduced by Eastman Kodak in 1923, the 16mm film was engineered as a portable and cost-effective alternative to the 35mm industry standard. Originally intended for amateur filmmakers and television production, its accessibility allowed independent directors and producers to bypass the financial and technical constraints of the major studio systems, effectively democratizing the cinematic medium. The defining aesthetic of 16mm is its pronounced film grain. Due to the smaller physical frame size compared to 35mm, the silver halide crystals—the organic building blocks of the image—become more visible upon enlargement. While once considered a technical limitation, this texture is now recognized as a source of physical depth that digital sensors cannot replicate.",
            movies: [
                ...
                { title: "THE SMASHING MACHINE", director: "Benny Safdie", type: "Color", year: 2025, frames: ["smashing-images/smashing1.png", "smashing2.jpg"] }
            ]
        },
        "35mm": {
            summary: "Since its standardization by the Motion Picture Patents Company in 1909, 35mm has remained as the backbone of global cinema. Its four-perforation frame structure offered a balance between chemical resolution and mechanical reliability, establishing a visual language that defined the 20th century. This format provides a clarity wich a natural sharpness of the scenes. The 1.37:1 Academy ratio or the 2.39:1 Anamorphic stretch on 35mm defined the golden ratio of cinema over 100 years.",
            movies: [
